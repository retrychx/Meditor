...
final class TemplateStore: TemplateStoreProtocol {
    ...
    static var builtins: [DocumentTemplate] {[
        ...
        DocumentTemplate(id: "prd",          name: L("template.prd"),          description: L("template.prdDesc"),          content: BuiltinTemplates.prd,           isBuiltin: true, createdAt: .distantPast, fileExtension: "md",   category: .markdown),
        DocumentTemplate(id: "bug-report",   name: L("template.bugReport"),    description: L("template.bugReportDesc"),    content: BuiltinTemplates.bugReport,     isBuiltin: true, createdAt: .distantPast, fileExtension: "md",   category: .markdown),
        DocumentTemplate(id: "reading-notes",name: L("template.readingNotes"), description: L("template.readingNotesDesc"), content: BuiltinTemplates.readingNotes,  isBuiltin: true, createdAt: .distantPast, fileExtension: "md",   category: .markdown),
        DocumentTemplate(id: "release-notes",name: L("template.releaseNotes"), description: L("template.releaseNotesDesc"), content: BuiltinTemplates.releaseNotes,  isBuiltin: true, createdAt: .distantPast, fileExtension: "md",   category: .markdown),
        DocumentTemplate(id: "retrospective",name: L("template.retrospective"),description: L("template.retrospectiveDesc"),content: BuiltinTemplates.retrospective, isBuiltin: true, createdAt: .distantPast, fileExtension: "md",   category: .markdown),
        ...
        DocumentTemplate(id: "html-tufte",   name: L("template.htmlTufte"),   description: L("template.htmlTufteDesc"),   content: BuiltinTemplates.htmlTufte,    isBuiltin: true, createdAt: .distantPast, fileExtension: "html", category: .htmlTheme),
        DocumentTemplate(id: "html-craft",   name: L("template.htmlCraft"),   description: L("template.htmlCraftDesc"),   content: BuiltinTemplates.htmlCraft,    isBuiltin: true, createdAt: .distantPast, fileExtension: "html", category: .htmlTheme),
        DocumentTemplate(id: "html-dark",    name: L("template.htmlDark"),    description: L("template.htmlDarkDesc"),    content: BuiltinTemplates.htmlDark,     isBuiltin: true, createdAt: .distantPast, fileExtension: "html", category: .htmlTheme),
        DocumentTemplate(id: "html-landing", name: L("template.htmlLanding"), description: L("template.htmlLandingDesc"), content: BuiltinTemplates.htmlLanding,  isBuiltin: true, createdAt: .distantPast, fileExtension: "html", category: .htmlTheme),
        DocumentTemplate(id: "html-report",  name: L("template.htmlReport"),  description: L("template.htmlReportDesc"),  content: BuiltinTemplates.htmlReport,   isBuiltin: true, createdAt: .distantPast, fileExtension: "html", category: .htmlTheme),
        DocumentTemplate(id: "html-resume",  name: L("template.htmlResume"),  description: L("template.htmlResumeDesc"),  content: BuiltinTemplates.htmlResume,   isBuiltin: true, createdAt: .distantPast, fileExtension: "html", category: .htmlTheme),
    ]}
